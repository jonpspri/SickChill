...
def delete_folder(folder, check_empty=True):
    ...
    if check_empty:
        ...
        try:
            ...
            logger.log("Warning: unable to delete folder: {0}: {1}".format(folder, repr(e)), logger.WARNING)
            return False
    else:
        try:
    ...
    for cur_file in unwanted_files:
        ...
        if not file_attribute & stat.S_IWRITE:
            ...
            try:
                ...
                result.output += log_helper("Cannot change permissions of {0}: {1}".format(cur_file_path, repr(e)), logger.DEBUG)
        try:
    ...
    if sickbeard.UNPACK == sickbeard.UNPACK_PROCESS_CONTENTS and rar_files:
        ...
        for archive in rar_files:
            ...
            try:
                ...
                failure = (repr(e), 'Unpacking failed')
            finally:
                if rar_handle:
                    del rar_handle
