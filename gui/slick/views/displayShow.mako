            ...
            % for epResult in sql_results:
                ...
                % if int(epResult["season"]) != curSeason:
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <br/>
                            <h3 style="display: inline;"><a name="season-${epResult["season"]}"></a>${(_("Specials"), _("Season") + ' ' + str(epResult["season"]))[int
                ...
                % endif
                                    <tr class="${Overview.overviewStrings[epCats[epStr]]} season-${curSeason} seasonstyle" id="${'S' + str(epResult["season"]) + 'E' + str(epResult["episode"])}">
                                        ...
                                        <td align="center"><img src="${static_url('images/' + ("nfo-no.gif", "nfo.gif")[epResult["hasnfo"]])}" alt="${("N", "Y")[epResult["hasnfo"]]}" width="23" height="11" /></td>
                                        <td align="center"><img src="${static_url('images/' + ("tbn-no.gif", "tbn.gif")[epResult["hastbn"]])}" alt="${("N", "Y")[epResult["hastbn"]]}" width="23" height="11" /></td>
                                        ...
                                        <td class="col-name">
                                            % if epResult["description"] != "" and epResult["description"] is not None:
                                                <img src="${static_url('images/info32.png')}" width="16" height="16" class="plotInfo" alt="" id="plot_info_${str(show.indexerid)}_${str(epResult["season"])}_${str(epResult["episode"])}" />
                                            % else:
